...
func ledgerEntryRow(e store.EntryRow) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 85, ">Irregular</option></select></div><!-- Row 2: Start | Period | Priority --><div style=\"display:flex;gap:12px;align-items:center;margin-bottom:8px;flex-wrap:wrap\"><input class=\"js-start-date js-date-fp\" type=\"text\" value=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if e.Source != "system" {
			...
			if e.RecurrenceAnchor != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1073, Col: 157}
				}
			...
			if e.NextDueDate != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1076, Col: 135}
				}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 101, "</div><!-- Conditions editor --><div style=\"flex:1;padding:12px 20px;display:flex;flex-direction:column;gap:6px;min-width:0\"><div style=\"font-size:11px;font-weight:600;color:var(--text3);text-transform:uppercase;letter-spacing:0.06em\">Matching Rule</div><textarea class=\"js-conditions-ta\" data-entry-id=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1087, Col: 27}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1097, Col: 10}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1099, Col: 42}
		}
		...
		if len(e.SampleMerchants) > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1105, Col: 82}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1128, Col: 110}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1128, Col: 153}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1129, Col: 139}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1130, Col: 130}
		}
		...
		if e.MatchedTransactionCount != nil {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1137, Col: 10}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1145, Col: 49}
		}
...
func ledgerConfBar(label string, f *float64) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1155, Col: 91}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1157, Col: 36}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1159, Col: 85}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `page/ledger.templ`, Line: 1159, Col: 99}
		}
